...
router.post('/:company_id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, Company_1["default"].findOne({ uuid: company_id })];
            case 2:
                comp = _a.sent();
                if (comp == null)
                    return [2 /*return*/, res.status(422).json({
                ...
                return [4 /*yield*/, Team_1["default"].create(__assign(__assign({}, req.body), { company_id: company_id, uuid: (0, uuid_1.v4)() }))];
            case 3:
                team = _a.sent();
